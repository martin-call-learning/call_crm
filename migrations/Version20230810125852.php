 ...
 */
final class Version20230810125852 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contact ADD COLUMN updated_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE contact ADD COLUMN deleted_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO contact (id, organisation_id, firstname, lastname, email, phonenumber, address) SELECT id, organisation_id, firstname, lastname, email, phonenumber, address FROM __temp__contact');
