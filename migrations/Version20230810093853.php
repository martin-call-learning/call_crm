 ...
 */
final class Version20230810093853 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contact ADD COLUMN created_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE contact ADD COLUMN deleted_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE contact ADD COLUMN updated_at DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contact (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, orgid_id INTEGER DEFAULT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, email VARCHAR(255) DEFAULT NULL, phonenumber INTEGER DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_4C62E638BB89FAD4 FOREIGN KEY (orgid_id) REFERENCES organisation (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO contact (id, orgid_id, firstname, lastname, email, phonenumber, address) SELECT id, orgid_id, firstname, lastname, email, phonenumber, address FROM __temp__contact');
        ...
        $this->addSql('CREATE TABLE "user" (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, contactid_id INTEGER DEFAULT NULL, username VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, role INTEGER NOT NULL, CONSTRAINT FK_8D93D649A9E6CB3 FOREIGN KEY (contactid_id) REFERENCES contact (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
