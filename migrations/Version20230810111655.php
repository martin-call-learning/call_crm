 ...
 */
final class Version20230810111655 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__contact AS SELECT id, orgid_id, firstname, lastname, email, phonenumber, address FROM contact');
        ...
        $this->addSql('INSERT INTO contact (id, organisation_id, firstname, lastname, email, phonenumber, address) SELECT id, orgid_id, firstname, lastname, email, phonenumber, address FROM __temp__contact');
        ...
        , price DOUBLE PRECISION NOT NULL, expected_student_count INTEGER DEFAULT NULL, remote BOOLEAN NOT NULL, presential BOOLEAN NOT NULL, level_required INTEGER DEFAULT NULL, CONSTRAINT FK_67D582BF5200282E FOREIGN KEY (formation_id) REFERENCES formation (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE funder (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, organisation_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, CONSTRAINT FK_6CFB4E659E6B1585 FOREIGN KEY (organisation_id) REFERENCES organisation (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE session (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, formation_action_id INTEGER NOT NULL, start_date DATE NOT NULL, end_date DATE NOT NULL, CONSTRAINT FK_D044D5D4574FA0E8 FOREIGN KEY (formation_action_id) REFERENCES formation_action (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE student (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, contact_id INTEGER NOT NULL, CONSTRAINT FK_B723AF33E7A1254A FOREIGN KEY (contact_id) REFERENCES contact (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE test (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, skill_id INTEGER NOT NULL, student_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, score INTEGER NOT NULL, CONSTRAINT FK_D87F7E0C5585C142 FOREIGN KEY (skill_id) REFERENCES skill (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_D87F7E0CCB944F1A FOREIGN KEY (student_id) REFERENCES student (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('INSERT INTO user (id, contactid_id, username, password, role) SELECT id, contactid_id, username, password, role FROM __temp__user');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE contact');
        $this->addSql('CREATE TABLE contact (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, orgid_id INTEGER DEFAULT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, email VARCHAR(255) DEFAULT NULL, phonenumber INTEGER DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, deleted_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, CONSTRAINT FK_4C62E638BB89FAD4 FOREIGN KEY (orgid_id) REFERENCES organisation (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO contact (id, orgid_id, firstname, lastname, email, phonenumber, address) SELECT id, organisation_id, firstname, lastname, email, phonenumber, address FROM __temp__contact');
        $this->addSql('DROP TABLE __temp__contact');
        $this->addSql('CREATE INDEX IDX_4C62E638BB89FAD4 ON contact (orgid_id)');
        $this->addSql('ALTER TABLE formation ADD COLUMN created_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE formation ADD COLUMN deleted_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE formation ADD COLUMN updated_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE formation_action ADD COLUMN created_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE formation_action ADD COLUMN deleted_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE formation_action ADD COLUMN updated_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE funder ADD COLUMN created_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE funder ADD COLUMN deleted_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE funder ADD COLUMN updated_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE funding_type ADD COLUMN created_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE funding_type ADD COLUMN deleted_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE funding_type ADD COLUMN updated_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE organisation ADD COLUMN created_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE organisation ADD COLUMN deleted_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE organisation ADD COLUMN updated_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE session ADD COLUMN created_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE session ADD COLUMN deleted_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE session ADD COLUMN updated_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE skill ADD COLUMN created_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE skill ADD COLUMN deleted_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE skill ADD COLUMN updated_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE student ADD COLUMN created_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE student ADD COLUMN deleted_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE student ADD COLUMN updated_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE test ADD COLUMN created_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE test ADD COLUMN deleted_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE test ADD COLUMN updated_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE "user" ADD COLUMN created_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE "user" ADD COLUMN deleted_at DATETIME NOT NULL');
